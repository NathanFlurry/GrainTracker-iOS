...
extension UIColor {
    ...
    convenience init?(hexString: String) {
        ...
        if cleanString.characters.count == 3 {
            let num1 = cleanString[0...1]
            let num2 = cleanString[1...2]
            let num3 = cleanString[2...3]
        ...
        guard NSScanner(string: cleanString).scanHexInt(&baseValue) == true else {
    ...
    func offsetColors(amnt: CGFloat) -> UIColor {
